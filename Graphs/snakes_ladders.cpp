...
//You have complete control over the die and can get any number from 1-6
//For given ladders and snakes, find minimum steps to reach.

//use bfs 
//push 1 into the queue
//  for all possiblilities in the dice: 
//      check if the next position is ladder, snake or empty
//      mark the square as visited and push into queue
//stop the traversal, when u reached 100
